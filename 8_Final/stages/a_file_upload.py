...
def register_callbacks(app):
    ...
    # Validation logic for Method 1 (Raw data uploads)
    @app.callback(
    ...
    def validate_method_1(n_clicks, contig_info, contig_matrix, binning_info, bin_taxonomy, current_stage):
        ...
        try:
            ...
            contig_data = parse_contents(contig_info, 'contig_info.csv')
            ...
            return 'Data Processing', "All files successfully validated!"
    ...
    def validate_method_2(n_clicks, contents, filename, current_stage):
        ...
        try:
            ...
            validate_unnormalized_folder(file_list)
            # If validation passes, move to the next stage
            return 'Normalization', "Unnormalized folder successfully validated!"
    ...
    def validate_method_3(n_clicks, contents, filename, current_stage):
        ...
        try:
            ...
            validate_normalized_folder(file_list)
            # If validation passes, move to the next stage
            return 'Visualization', "Normalized folder successfully validated!"
