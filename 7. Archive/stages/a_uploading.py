...
def create_upload_layout(method):
    if method == "method1":
        return html.Div([
            html.Div(id='upload-component-container-method1', children=[
                dbc.Row([
            ...
            dbc.Button("Validate All Files", id="validate-button-method1", color="success", className="mt-3"),
            html.Div(id="validation-output-method1", style={'padding': '0px', 'color': 'green'})
        ])
    elif method == "method2":
        return html.Div([
            html.Div(id='upload-component-container-method2', children=[
                dbc.Row([
                    dbc.Col(create_upload_component(
            ...
            dbc.Button("Validate All Files", id="validate-button-method2", color="success", className="mt-3"),
            html.Div(id="validation-output-method2", style={'padding': '0px', 'color': 'green'})
        ])
    elif method == "method3":
        return html.Div([
            html.Div(id='upload-component-container-method3', children=[
                dbc.Row([
                    dbc.Col(create_upload_component(
            ...
            dbc.Button("Validate All Files", id="validate-button-method3", color="success", className="mt-3"),
            html.Div(id="validation-output-method3", style={'padding': '0px', 'color': 'green'})
        ])
...
def register_callbacks(app):
    ...
    # Validation and saving for Method 1
    @app.callback(
    ...
    # Callback for Method 2 file uploads
    @app.callback(
    ...
    # Validation and saving for Method 2
    @app.callback(
    ...
    # Callback for Method 3 file uploads
    @app.callback(
    ...
    # Validation and saving for Method 3
    @app.callback(
